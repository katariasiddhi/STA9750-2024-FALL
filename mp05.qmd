...
format:
  html:
    theme: lux          # Use your preferred theme
    css: styles.css     # Optional: Add your custom CSS for styles
    toc: true           # Include a table of contents
    toc-depth: 2        # Depth for table of contents
    number-sections: true

publish:
  gh_pages:
    branch: gh-pages    # Publish to the `gh-pages` branch
    path: /             # Root directory of the GitHub Pages site
---
